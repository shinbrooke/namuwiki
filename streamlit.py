...
with st.expander("시사점 및 제언"):
    ...
    1. 나무위키를 통해 효과적인 집단지성의 구축이 가능합니다. 다만, 활발한 축적 방식의 토론을 기반으로 할 때 질 높은 집단지성을 형성할 수 있을 것으로 보입니다.
        - 많은 수의 참여자들이, 글자를 추가하는 방향으로 편집하는 것을 확인할 수 있었습니다. 이는 다양한 사람들의 참여를 통한 축적이 이루어짐을 시사하는 듯합니다.
        - 페이지별로 편집의 cumulative sum을 확인했을 때, 어느 정도 시간이 지난 후에는 수정이 줄어들면서 문서가 안정화되는 모습을 보여주었습니다. 이는 어느 정도 합의된 집단 지성의 구축을 의미한다고 볼 수 있습니다.
    """)
