...
st.markdown("""3. 나무위키 플랫폼에서 '토론' 및 '역사'를 확인할 수 있는 기능을 제공하고 있지만, 대부분의 사용자들은 이를 따로 확인하지 않은 채 페이지상의 정보에 그대로 노출됩니다. 나무위키에서 지식을 습득할 때 편향되거나 근거가 불분명한 정보가 있을 수 있음을 자각하고, 개개인이 지식 습득에 있어서의 분별력을 기를 필요가 있을 것으로 보입니다. 한편, 보다 객관적이고 신뢰성 있는 정보를 전달하기 위해 각주에 출처를 명확히 표기하는 등의 방법이 보다 활성화될 필요도 있을 것입니다.""")
