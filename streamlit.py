...
st.markdown("""
[참고] 임진왜란 키워드의 코멘트는 아래에서 확인할 수 있습니다. 단순히 다양한 관점의 내용을 보충하는 것이 아니라, 다소 공격적인 어조로 왜곡된 정보에 대한 지적이 많이 이루어지는 것을 확인할 수 있습니다. 보다 정확한 고증을 위한 경우도 있겠으나, 자신의 주관적 의견을 내세우고 다른 의견을 무시하는 양상으로도 해석할 수 있을 것으로 보입니다.
""")
